...
ax1.set_ylabel('$\mathcal{R}$ PISN after merger $(Gpc^{-3}yr^{-1})$', fontsize=12 )
...
ax2.set_ylabel('$\mathcal{R}$ PISN no merger $(Gpc^{-3}yr^{-1})$', fontsize=12 )
...
ax3.set_ylabel('$\mathcal{R}$ PPISN after merger $(Gpc^{-3}yr^{-1})$', fontsize=12 )
...
ax4.set_yscale('log')
ax4.set_ylim(10**0,10**4)
ax4.set_xlabel('Redshift (z)')
ax4.yaxis.tick_right()
ax4.yaxis.set_label_position("right")
ax4.set_ylabel('$\mathcal{R}$ PPISN before merger $(Gpc^{-3}yr^{-1})$', fontsize=12 )
plt.setp(ax2.get_yticklabels()[0], visible=False) 
plt.setp(ax4.get_yticklabels()[0], visible=False) 
plt.setp(ax1.get_xticklabels(), visible=False)
plt.setp(ax3.get_xticklabels(), visible=False)
plt.legend(loc='upper center',frameon=False, bbox_to_anchor=(0.0, 1.15),ncol=2)
